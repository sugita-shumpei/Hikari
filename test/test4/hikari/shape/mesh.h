...
namespace hikari {
  inline namespace shape {
    ...
    inline auto convertMeshIndexFormat2Str(const MeshIndexFormat& index_format) -> Str {
      if (index_format == MeshIndexFormat::eU16) { return "U16"; }
      if (index_format == MeshIndexFormat::eU32) { return "U32"; }
      return "U32";
    }
    inline auto convertStr2MeshIndexFormat(const Str& str) -> std::optional<MeshIndexFormat> {
      if (str == "U16") { return MeshIndexFormat::eU16; }
      if (str == "U32") { return MeshIndexFormat::eU32; }
      return std::nullopt;
    }
    struct ShapeMeshObject : public ShapeObject {
      ...
      static inline Bool Convertible(const Str& str) noexcept {
       ...
       auto getUV(U32 idx) const->Array<Vec3> { if (idx >= 9) { return {}; } else { return m_uvs[idx]; } }
#define HK_SHAPE_MESH_GET_UV_DEFINE(IDX) Array<Vec3> getUV##IDX() const { return getUV<IDX>(); }
       ...
       void setPositions(const Array<Vec3> & positions) {
         ...
         if (m_vertex_count != positions.size()) {
           ...
           m_tangents.clear();
           m_colors.clear();
           for (auto& uv : m_uvs) { uv.clear(); }
           m_vertex_count = positions.size();
         }
         m_positions = positions;
         recalculateBBox();
       }
       void setNormals  (const Array<Vec3> & normals    ) { if (m_immutable) { return; } if (normals.size()  != m_vertex_count) { return; } m_normals  = normals; }
       void setTangents (const Array<Vec4> & tangents   ) { if (m_immutable) { return; } if (tangents.size() != m_vertex_count) { return; } m_tangents = tangents; }
       void setColors(const Array<ColorRGBA>& colors ) { if (m_immutable) { return; } if (colors.size()   != m_vertex_count) { return; } m_colors   = colors; }
       void setUV(U32 idx, const Array<Vec2>& uv) { if (m_immutable) { return; } if (idx >= 9) { return; } if (uv.size() != m_vertex_count) { return; } m_uvs[idx] = transformArray(uv, [](const auto& v) {return Vec3(v, 0.0f); }); }
       void setUV(U32 idx, const Array<Vec3>& uv) {
         if (m_immutable) { return; }
         if (idx >= 9) { return; } if (uv.size() != m_vertex_count) { return; }
         m_uvs[idx] = uv;
       }
       template<U32 idx, std::enable_if_t<idx <= 8, nullptr_t> = nullptr>
       void setUV(const Array<Vec2>& uv) { if (m_immutable) { return; } if (idx >= 9) { return; } if (uv.size() != m_vertex_count) { return; } m_uvs[idx] = transformArray(uv,[](const auto& v) {return Vec3(v, 0.0f); }); }
       template<U32 idx, std::enable_if_t<idx <= 8, nullptr_t> = nullptr>
       void setUV(const Array<Vec3>& uv) { if (m_immutable) { return; } if (idx >= 9) { return; } if (uv.size() != m_vertex_count) { return; } m_uvs[idx] = uv; }
#define HK_SHAPE_MESH_SET_UV_DEFINE(IDX) void setUV##IDX(const Array<Vec2>& uv) { setUV<IDX>(uv); } void setUV##IDX(const Array<Vec3>& uv) { setUV<IDX>(uv); }
       ...
       Bool hasUV(U32 idx)const { if (idx >= 9) { return false; } return !m_uvs[idx].empty(); }
       template<U32 idx, std::enable_if_t<idx <= 8, nullptr_t> = nullptr>
       Bool hasUV() const { return !m_uvs[idx].empty(); }
#define HK_SHAPE_MESH_HAS_UV_DEFINE(IDX) Bool hasUV##IDX() const { return hasUV<IDX>(); }
       ...
       void toImmutable() noexcept { if (m_immutable) { return; } m_immutable = true; }
    ...
    struct ShapeMeshImpl : protected ShapeImpl<ShapeMeshObjectT> {
      ...
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getIndices, Array<U32>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getPositions, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getNormals, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getTangents, Array<Vec4>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getColors, Array<ColorRGBA>, {});
      auto getUV(U32 idx) const -> Array<Vec3> {
        auto obj = getObject(); if (!obj) { return {}; }
        return obj->getUV(idx);
      }
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getUV, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getUV0, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getUV1, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getUV2, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getUV3, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getUV4, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getUV5, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getUV6, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getUV7, Array<Vec3>, {});
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getUV8, Array<Vec3>, {});

      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setIndices, Array<U32>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setPositions, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setNormals, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setTangents, Array<Vec4>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setColors, Array<ColorRGBA>);
      ...
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV, Array<Vec2>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV0, Array<Vec2>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV1, Array<Vec2>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV2, Array<Vec2>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV3, Array<Vec2>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV4, Array<Vec2>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV5, Array<Vec2>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV6, Array<Vec2>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV7, Array<Vec2>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV8, Array<Vec2>);

      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV0, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV1, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV2, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV3, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV4, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV5, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV6, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV7, Array<Vec3>);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setUV8, Array<Vec3>);

      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(hasUV, Bool, false);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(hasUV0, Bool, false);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(hasUV1, Bool, false);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(hasUV2, Bool, false);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(hasUV3, Bool, false);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(hasUV4, Bool, false);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(hasUV5, Bool, false);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(hasUV6, Bool, false);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(hasUV7, Bool, false);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(hasUV8, Bool, false);

      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getVertexCount, U32, 0);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getIndexCount, U32, 0);

      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE_WITH_DEF(getIndexFormat, MeshIndexFormat, MeshIndexFormat::eU32);
      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_SETTER_LIKE(setIndexFormat, MeshIndexFormat);

      HK_OBJECT_WRAPPER_METHOD_OVERLOAD_GETTER_LIKE(isImmutable, Bool, false);
      void toImmutable() noexcept { auto obj = getObject(); if (obj) { obj->toImmutable(); }; }
