...
int main() {
	...
	auto envlit_filename = std::string(R"(D:\Users\shums\Documents\CMake\RTLib\Data\Textures\evening_road_01_4k.hdr)");
		...
		{
			{
				...
				owlGeomTypeSetClosestHit(geom_types[0][0], RAY_TYPE_RADIANCE, module, "radianceCH");
				owlGeomTypeSetClosestHit(geom_types[0][0], RAY_TYPE_OCCLUDED, module, "occludedCH");
			}
			{
				OWLVarDecl var_decls[] = {
					OWLVarDecl{"vertices"           ,OWLDataType::OWL_BUFPTR     ,offsetof(HitgroupData,vertices) },
				...
				owlGeomTypeSetClosestHit(geom_types[0][1], RAY_TYPE_RADIANCE, module, "radianceCH");
				owlGeomTypeSetClosestHit(geom_types[0][1], RAY_TYPE_OCCLUDED, module, "occludedCH");
				owlGeomTypeSetAnyHit(geom_types[0][1]    , RAY_TYPE_RADIANCE, module, "simpleAH");
				owlGeomTypeSetAnyHit(geom_types[0][1]    , RAY_TYPE_OCCLUDED, module, "simpleAH");
			}
		}
		{
			{
				...
				owlGeomTypeSetClosestHit(geom_types[1][0], RAY_TYPE_RADIANCE, module, "radianceCHWithNormalShading");
				owlGeomTypeSetClosestHit(geom_types[1][0], RAY_TYPE_OCCLUDED, module, "occludedCH");
			}
			{
				OWLVarDecl var_decls[] = {
					OWLVarDecl{"vertices"           ,OWLDataType::OWL_BUFPTR     ,offsetof(HitgroupData,vertices) },
				...
				owlGeomTypeSetClosestHit(geom_types[1][1], RAY_TYPE_RADIANCE, module, "radianceCHWithNormalShading");
				owlGeomTypeSetClosestHit(geom_types[1][1], RAY_TYPE_OCCLUDED, module, "occludedCH");
				owlGeomTypeSetAnyHit(geom_types[1][1]    , RAY_TYPE_RADIANCE, module, "simpleAH");
				owlGeomTypeSetAnyHit(geom_types[1][1]    , RAY_TYPE_OCCLUDED, module, "simpleAH");
			}
		}
		{
			{
				...
				owlGeomTypeSetClosestHit(geom_types[2][0], RAY_TYPE_RADIANCE, module, "radianceCHWithNormalMap");
				owlGeomTypeSetClosestHit(geom_types[2][0], RAY_TYPE_OCCLUDED, module, "occludedCH");
			}
			{
				OWLVarDecl var_decls[] = {
					OWLVarDecl{"vertices"           ,OWLDataType::OWL_BUFPTR     ,offsetof(HitgroupData,vertices) },
				...
				owlGeomTypeSetClosestHit(geom_types[2][1], RAY_TYPE_RADIANCE, module, "radianceCHWithNormalMap");
				owlGeomTypeSetClosestHit(geom_types[2][1], RAY_TYPE_OCCLUDED, module, "occludedCH");
				owlGeomTypeSetAnyHit(geom_types[2][1], RAY_TYPE_RADIANCE, module, "simpleAH");
				owlGeomTypeSetAnyHit(geom_types[2][1], RAY_TYPE_OCCLUDED, module, "simpleAH");
			}
		}
	}
		...
		for (auto& [name, mesh] : model) {
			{
				...
				auto colors   = mesh.getVisSmoothColors();
				{
					...
					if (mesh.normals[0].x!=0.0f|| mesh.normals[0].z != 0.0f || mesh.normals[0].y != 0.0f) {
				...
				for (auto i = 0; i < mesh.materials.size(); ++i) {
					...
					if (has_vnormal){ owlGeomSetBuffer(trim, "normals", norm_buf); }
