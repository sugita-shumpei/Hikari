#pragma once
#include <memory>
#include <hikari/framework/core/property.h>
#include <hikari/framework/core/common.h>
...
namespace hikari {
  namespace core {
    ...
    public:
      ...
      auto getPropertyNames() const -> Array<Str>
      {
        auto object = getObject();
        if (!object)
        {
    ...
    struct Object {
      ...
      virtual auto getPropertyNames() const  -> Array<Str> = 0;
